...
function setMobileMenu() {
	$("#page-menu-open").click(function (e) {
		e.preventDefault();
		$("#page-menu").fadeIn(100);
		$(document.body).addClass("no-scroll");
	});

	$("#page-menu-close").click(function (e) {
		e.preventDefault();
		$("#page-menu").fadeOut(100);
		$(document.body).removeClass("no-scroll");
	});

	if (isPhone()) {
		$("#page-menu .inner a").click(function () {
			$("#page-menu").fadeOut(100);
			$(document.body).removeClass("no-scroll");
		});
	}
...
function setupSmoothScroll() {
	$("a").on("click", function (e) {
		if (this.hash !== "") {
			e.preventDefault();
			$("html, body").animate(
				{ scrollTop: $(this.hash).offset().top - (isPhone() ? 100 : 0) },
				800,
			);
		}
	});
